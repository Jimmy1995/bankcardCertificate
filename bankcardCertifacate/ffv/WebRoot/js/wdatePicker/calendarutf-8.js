...
document.write("<iframe name=meizzCalendarIframe scrolling=no frameborder=0 width=100% height=120%></iframe></div>");
...
{
    this.regInfo    = "东莞市开普互联信息有限公司：2004";//当移到关闭按钮时显示的版权信息
    ...
    this.darkColor  = "#0087BC";    //控件的暗色

    this.lightColor = "#FFFFFF";    //控件的亮色

    this.btnBgColor = "#E4F7FF";    //控件的按钮背景色
    this.wordColor  = "#000040";    //控件的文字颜色

    this.wordDark   = "#DCDCDC";    //控件的暗文字颜色
    this.dayBgColor = "#FFFEF1";    //日期数字背景色

    this.todayColor = "#FF9933";    //今天在日历上的标示背景色
    this.DarkBorder = "#E3E3E3";    //日期显示的立体表达色
...
function isTime(str)
{
	...
	if (a == null) {alert('输入的参数不是时间格式.格式:时(00-23):分(00-59):秒(00-59).'); return false;}
	if (a[1]>23 || a[3]>59 || a[4]>59)
	{
		alert("您输入的时间不正确.格式:时(00-23):分(00-59):秒(00-59).");
		return false
	}
	return true;
}
