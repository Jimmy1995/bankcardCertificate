...
<HTML>
	...
	<BODY>
						<form name="form1" id="form1" method="post"	action="${ctx }/manage/quartz-job-manage!save.action" >
							<sys:editorlayout cols="1,3,2">
								<sys:editorlayout-row>
									<sys:textfield name="jobName" id="jobName" label="任务名称" showTip="true"/>
								</sys:editorlayout-row>
								<sys:editorlayout-row>
									<sys:textfield name="jobGroup" id="jobGroup" label="任务组名" showTip="true"/>
								</sys:editorlayout-row>
								<sys:editorlayout-row>
									<sys:textfield name="description" id="description" label="任务描述" showTip="true"/>
								</sys:editorlayout-row>
								<sys:editorlayout-row>
									<sys:textfield name="cronExpression" id="cronExpression" label="表达式" showTip="true"/>
								</sys:editorlayout-row>
								<sys:editorlayout-row>
									<sys:textfield name="stateFulljobExecuteClass" id="stateFulljobExecuteClass" label="运行类" showTip="true"/>
								</sys:editorlayout-row>
								<sys:editorlayout-row>
