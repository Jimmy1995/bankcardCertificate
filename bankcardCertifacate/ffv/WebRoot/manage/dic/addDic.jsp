...
<HTML>
	...
	<BODY>
						...
						<form name="form1" id="form1" method="post"	action="${ctx }/manage/dic-manage!save.action" >
									 ...
									 <div class="col-3" style="overflow: auto;height: 200px">
											...
											<script type="text/javascript">
												...
												<c:forEach items="${roles}" var="role" varStatus="s">
												   d.add("${role.roleId}", "0", "<input type='checkBox' name='pojo.roles' value='${role.roleId}' checked >${role.roleName }");       	
												</c:forEach>
												document.write(d);
										...
										<div class="col-9">
											<input type="hidden" id="parentDic.dicId" name="parentDic.dicId" value="${parentDic.dicId}"/>
											<sys:editorlayout cols="1,3,2">
												<sys:editorlayout-row>
													<sys:textfield name="obj.codetype" id="codetype" label="归类" showTip="true"/>
												</sys:editorlayout-row>
												<sys:editorlayout-row>
													<sys:textfield name="dicKey" id="dicKey" label="代码" showTip="true"/>
												</sys:editorlayout-row>
												<sys:editorlayout-row>
													<sys:textfield name="dicValue" id="dicValue" label="显示值" showTip="true"/>
												</sys:editorlayout-row>
												<sys:editorlayout-row>
													<sys:textfield name="orders" id="orders" label="排序" showTip="true"/>
												</sys:editorlayout-row>
												<sys:editorlayout-row>
													<sys:textfield name="description" id="description" label="描述" showTip="true"/>
												</sys:editorlayout-row>
												<sys:editorlayout-row>
