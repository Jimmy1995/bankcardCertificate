...
<HTML>
	...
	<frameset rows="*" cols="*,40,*" framespacing="0" frameborder="no"
		...
		<frame
			src="${ctx }/manage/user-manage!listUsersByRole.action?roleid=${param.roleid}&isThisRole=0"
			name="leftFrame1" scrolling="No" noresize="noresize" id="leftFrame1" />
		<frame src="mid.jsp" name="mid" noresize="noresize" scrolling="No"
			id="mid" />
		<frame
			src="${ctx }/manage/user-manage!listUsersByRole.action?roleid=${param.roleid}&isThisRole=1"
