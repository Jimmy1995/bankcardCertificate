...
<HTML>
	...
	<BODY>
						...
						<form name="form1" id="form1" method="post"	action="${ctx }/manage/action-manage!alter.action" >
							<input type="hidden" id="actionId" name="obj.actionId" value="${obj.actionId }" />
							<sys:editorlayout cols="1,3,2">
								<sys:editorlayout-row>
									<sys:textfield name="obj.actionName" id="actionName" showTip="true" label="权限描述"></sys:textfield>
								</sys:editorlayout-row>
								<sys:editorlayout-row>
									<sys:textfield name="obj.orders" id="orders" showTip="true" label="排序"></sys:textfield>
								</sys:editorlayout-row>
								<sys:editorlayout-row>
									...
									<sys:textarea name="obj.actionPath" id="actionPath" showTip="true" label="权限路径"></sys:textarea>
								<sys:editorlayout-row>
